# fs-cortex v3.29.0 — Feature Reference
...
| `test_v328_operational.sh` | 5 | `write_daily_snapshot` (creates JSON, idempotent, empty CORTEX_DIR), cx-stop session-learner exits 0, cx-analyze `--deep` spec present |
