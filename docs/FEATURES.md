# fs-cortex v3.36.0 — Feature Reference
...
| `test_storage_rotation.sh` | 43 | **v3.35.1 #56.2, extended v3.36.0** — rotate() rename-first split (no-loss invariant, idempotency, 0600 perms, malformed-line preservation, pre-scan no-op), storage-rotation.js size + 24h-marker gates, tracker prune wiring, learner Step 5f wiring; v3.36.0: rotation-window default/override/floor, proposals-history + knowledge-log rename-rotation, daily-dir retention, fire-once pruning, small-file no-ops |
