---
name: cx-dream
description: "[DEPRECATED v4] Run Dream Cycle — dedup, contradictions, staleness, regex, health, cleanup"
command: true
---

# /cx-dream — DEPRECATED en v4.0.0

Este comando fue absorbido por el set v4 (docs/DESIGN-V4.md).

**Usa en su lugar:** `/cx-maintain` — dedup Jaccard, purga de decaídos y health check viven ahora dentro del mantenimiento determinista único.
